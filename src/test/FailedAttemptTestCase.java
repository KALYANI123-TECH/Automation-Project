...
public class FailedAttemptTestCase {
	...
	@Test
	public void verifyDashboard_FailedAttempt() {

		driver.findElement(By.id("countbtn")).click();
		driver.findElement(By.id("loginmobile")).sendKeys("1234567832");
		driver.findElement(By.id("loginbtn")).click();
		driver.findElement(By.partialLinkText("Account")).click();
		driver.findElement(By.xpath("//div[@class = \"card card-stats card-danger\"]//following::div[4]/a")).click();
